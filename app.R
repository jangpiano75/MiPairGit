...
#if(!require('fBasics')) install.packages("fBasics", repos="http://R-Forge.R-project.org")
if(!require('RcppZiggurat')) remotes::install_version('RcppZiggurat', version = '0.1.6')
if(!require('Rfast')) remotes::install_version('Rfast', version = '2.0.6')
