...
{      
  ...
  HOME_COMMENT6 = p(strong("Reference"), ": Jang H, Koh H, Gu W, Kang B. (2022) Integrative web cloud computing and analytics using MiPair for design-based comparative analysis with paired microbiome data.", strong("Scientific Reports"), "12:20465 https://doi.org/10.1038/s41598-022-25093-6.", style = "font-size:13pt")
